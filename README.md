...
![636e2e99d3a9546506082364_Data Pipeline Components](https://github.com/Ackson507/Data-pipeline-with-Airflow-Orchestration/assets/84422970/6cc64297-90aa-4cdc-87c3-ad27e1a45429)
...
- Objective 3: Deploy Airflow management tool such as Apche Airflow to automate our data pipeline, we will need to define Directed Acyclic Graphs (DAGs) in Python. Each DAG will correspond to one of our data sources: one for loading and transforming data from a CSV file which is objective 2 and another for scraping data from an API which is Objective 1. Each DAG will consist of four tasks: extracting data, transforming data, loading data, and a final task to notify or log the completion and sent the data collected to our destination database PostgresSQL .
